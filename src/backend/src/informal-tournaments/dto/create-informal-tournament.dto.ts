...
export const TOURNAMENT_FORMATS = ['liga', 'eliminacion', 'grupos', 'amistoso'] as const;
export const TOURNAMENT_STATUSES = ['abierto', 'en_curso', 'finalizado'] as const;

export class CreateInformalTournamentDto {
  @IsString()
  @MaxLength(150)
  name!: string;
